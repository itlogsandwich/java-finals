...
![Java Chat System runtime flow](flowchart/flowchart.png)

The diagram is generated by [`flowchart/generate_flowchart.py`](flowchart/generate_flowchart.py) using matplotlib, and is exported to both PNG and SVG:
